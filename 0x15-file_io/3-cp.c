 ...
 *
 * Description: close the file descriptor and print an
 * error message upon error detected.
 *
 ...
 * @buff: the number of bytes to check.
 * @add: the number of bytes to add up and write.
 *
 * Description: writes the file and print error message on failure.
 *
 * Return: the number of bytes on Sucess, -1 if an error was encountered.
 */
