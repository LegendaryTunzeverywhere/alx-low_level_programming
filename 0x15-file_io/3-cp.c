 ...
 * @fd: file to close
 *
 * Description: close the file descriptor and print error message
 * upon error detected.
 *
 ...
 * @fd: the filde descriptor.
 * @buff: the number of bytes check.
 * @add: the number of bytes to add up an write.
 *
 * Description: writet the file and print error message on failure.
 *
